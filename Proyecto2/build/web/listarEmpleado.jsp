    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            <h1>Empleados</h1>
            <a class="btn btn-success" href="ControladorEmpleado?accion=add">Agregar Nuevo</a>
            <br>
            <br>
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center"><%= emp.getCelular()%></td>
                        <td class="text-center"><%= emp.getTipo()%></td>
                        <td class="text-center"><%= emp.getUsuario()%></td>
                        <td class="text-center"><%= emp.getContra()%></td>
